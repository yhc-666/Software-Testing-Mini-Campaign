...
public class CSVcomparator {
    ...
    public static void main(String[] args) {
        List<List<String>> list1 = read_csv_file("/Users/haochengyang/Desktop/Study/term5/software_engineering/Software-Testing-Mini-Campaign/Test_data/compare_csv_file_Test/The input space is partitioned based on if any file has records with missing values/Both files have several(>=1) repeat customer IDs/test1.csv");
        List<List<String>> list2 = read_csv_file("/Users/haochengyang/Desktop/Study/term5/software_engineering/Software-Testing-Mini-Campaign/Test_data/compare_csv_file_Test/The input space is partitioned based on if any file has records with missing values/Both files have several(>=1) repeat customer IDs/test2.csv");
