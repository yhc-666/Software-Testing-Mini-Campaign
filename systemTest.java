...
public class systemTest {
    ...
    public void testCompcsv2() {
        List<List<String>> list1 = CSVcomparator.read_csv_file("/Users/haochengyang/Desktop/Study/term5/software_engineering/Software-Testing-Mini-Campaign/Test_data/systest/file with one repeat customer ID/test1.csv");
        List<List<String>> list2 = CSVcomparator.read_csv_file("/Users/haochengyang/Desktop/Study/term5/software_engineering/Software-Testing-Mini-Campaign/Test_data/systest/file with one repeat customer ID/test2.csv");
        List<List<String>> diff = CSVcomparator.compare_csv_file(list1, list2);
        CSVcomparator.generate_csv_file(diff);
        List<List<String>> result = CSVcomparator.read_csv_file("/Users/haochengyang/Desktop/Study/term5/software_engineering/Software-Testing-Mini-Campaign/result/result.csv");
        List<List<String>> expect = CSVcomparator.read_csv_file("/Users/haochengyang/Desktop/Study/term5/software_engineering/Software-Testing-Mini-Campaign/Test_data/systest/file with one repeat customer ID/target.csv");
        assertEquals(expect,result);
    }
    // Test when Both files have several(>=1) repeat customer IDs.
    @Test
    public void testCompcsv3() {
        List<List<String>> list1 = CSVcomparator.read_csv_file("/Users/haochengyang/Desktop/Study/term5/software_engineering/Software-Testing-Mini-Campaign/Test_data/systest/both file has several repeat id/test1.csv");
        List<List<String>> list2 = CSVcomparator.read_csv_file("/Users/haochengyang/Desktop/Study/term5/software_engineering/Software-Testing-Mini-Campaign/Test_data/systest/both file has several repeat id/test2.csv");
        List<List<String>> diff = CSVcomparator.compare_csv_file(list1, list2);
        CSVcomparator.generate_csv_file(diff);
        List<List<String>> result = CSVcomparator.read_csv_file("/Users/haochengyang/Desktop/Study/term5/software_engineering/Software-Testing-Mini-Campaign/result/result.csv");
        List<List<String>> expect = CSVcomparator.read_csv_file("/Users/haochengyang/Desktop/Study/term5/software_engineering/Software-Testing-Mini-Campaign/Test_data/systest/both file has several repeat id/target.csv");
        assertEquals(expect,result);
    }
